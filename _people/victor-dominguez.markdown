...
His work at the Zardini Lab focused on developing methods for synthetic data generation to generate origin-destination matrices and is sponsored via the [SuperUROP program](https://superurop.mit.edu/).