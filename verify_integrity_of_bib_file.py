"""This script checks if the _bibliography/zardini-bib.bib is correctly formatted."""
...
if __name__ == "__main__":
    check_for_parsing_errors("_bibliography/zardini-bib.bib")
    check_for_deleted_entries("_bibliography/zardini-bib.bib")
